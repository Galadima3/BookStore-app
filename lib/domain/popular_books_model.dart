...
PopularBooksModel? testModelFromJson(String str) =>
    PopularBooksModel.fromJson(json.decode(str));

String testModelToJson(PopularBooksModel? data) => json.encode(data!.toJson());
...
class PopularBooksModel {
  ...
  factory PopularBooksModel.fromJson(Map<String, dynamic> json) => PopularBooksModel(
